package com.growdigitalbridge.attendance.client;

import com.fasterxml.jackson.annotation.JsonIgnoreProperties;
import com.growdigitalbridge.attendance.security.CurrentBearerToken;
 ...
 * caller's own validated identity to their employee reference. Attendance owns no employee
 * profile data itself (see MICROSERVICES.md boundary rules), so this is the only way any
 * endpoint here learns "who is the caller" as an employee ID.
 *
