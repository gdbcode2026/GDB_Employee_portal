package com.growdigitalbridge.leave.client;

import com.fasterxml.jackson.annotation.JsonIgnoreProperties;
import com.growdigitalbridge.leave.security.CurrentBearerToken;
 ...
 * caller's own validated identity to their employee reference. Leave owns no employee profile
 * data itself, so this is the only way any endpoint here learns "who is the caller" as an
 * employee ID.
 *
