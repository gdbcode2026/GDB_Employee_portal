package com.growdigitalbridge.employee.client;

import com.growdigitalbridge.employee.security.CurrentBearerToken;
 ...
 * scope used anywhere in Employee Service - no endpoint accepts a client-supplied team or
